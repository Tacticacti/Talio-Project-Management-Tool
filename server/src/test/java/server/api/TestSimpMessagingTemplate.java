...
public class TestSimpMessagingTemplate
        extends SimpMessagingTemplate
     ...
     * message leaves the application, the provided headers
     * are included with it
     * and delivered to the destination (e.g. the STOMP client
     * or broker).
     ...
     * payload, headers);
     * </pre>
     * <p><strong>Note:</strong> if the {@code MessageHeaders}
     * are mutable as in
     * the above example, implementations of this interface
     * should take notice and
     * update the headers in the same instance
     * (rather than copy or re-create it)
     ...
     */
    @Override
    public void convertAndSend(String destination
     ...
     * apply the given post processor,
